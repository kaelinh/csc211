...
def random_list():
    rnumb = []
    for a in range(100):
        rnumb.append(random.randint(0,1000))
    return(rnumb)
...
def average(numbers):
    ...
    for a in numbers:
        ...
        value = value + inta
    averagevalue = value / totalnumbers
    return averagevalue

Mylist = random_list()
TheAverage = average(Mylist)
...
def alice_text():
    with open('csc211/hw/hw2/Alice_In_Wonderland.txt') as rfp:
        text = rfp.read()
    return text
